 ...
 * kafka发送端参数优化
  */
public class CustomerProducerParameter {
    private static final Logger logger = LoggerFactory.getLogger(CustomerProducerParameter.class);
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 10; i++) {
            kafkaProducer.send(new ProducerRecord("first", "" + i, "kafka参数调优:" + i), new Callback() {
                @Override
