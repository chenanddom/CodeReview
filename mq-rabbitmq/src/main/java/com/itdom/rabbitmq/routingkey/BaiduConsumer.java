...
public class BaiduConsumer {
    public static void main(String[] args) throws IOException {
        ...
        channel.queueBind(RabbitmqConstants.WEATHER_BAIDU, RabbitmqConstants.WEATHER_EXCHANGE_ROUTING, "cn.guangdong.shenzhen.20220711");
        channel.queueBind(RabbitmqConstants.WEATHER_BAIDU, RabbitmqConstants.WEATHER_EXCHANGE_ROUTING, "cn.guangdong.dongguan.20220711");
